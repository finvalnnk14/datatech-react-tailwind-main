  ...
  alarmUnits: [
    {
      ...
      name: "FG-NET",
      description:
        "Terletak di pusat kota Jakarta, Jakarta 2 Data Center mempunyai kapasitas yang terukur dengan 2.800 rak co-lokasi. Sistem jaringannya adalah salah satu dari sedikit data center yang bersifat carrier-netral di Jakarta, terhubung ke 49 carries. Terhubung adalah gedung perkantoran dimana 3 IXs ditempatkan pada terowongan tahan gempa",
    },
    {
      id: 2,
      link: "fg-sys",
      ...
      <div className="container mx-auto flex bg-white font-poppins">
        <div className="relative left-0 top-0 min-w-[350px]">
          <div className="fixed top-0 z-[100] h-fit min-w-[350px] bg-blue-datatech p-8">
            ...
            <ul className="my-16 flex flex-col gap-4 text-2xl font-medium text-[#00F0FF] underline">
              <li
              ...
              <hr className="w-4/5 border-l border-white" />
              <li
              ...
              <hr className="w-4/5 border-l border-white" />
              <li className="cursor-pointer py-4">PROJECT 3</li>
              <hr className="w-4/5 border-l border-white" />
              <li
  ...
  return (
    <div className="flex flex-col gap-4 p-8">
      <div className="_ICON flex items-center gap-4">
        <h1 className="text-2xl font-semibold text-blue-datatech">
          Global Data Centers Indonesia (GDCI) – Jakarta 2
        </h1>
      </div>
      ...
      <div className="_CONTENT flex gap-8 text-blue-datatech">
        <div className="_LEFT_SECTION flex w-1/2 flex-col gap-4">
          ...
          <h2 className="text-2xl font-semibold text-blue-datatech">
            Global Data Centers Indonesia (GDCI) – Jakarta 2 Jakarta, 2020-2021
          </h2>
